...
{
    public SalGuiConsole(com.salhack.summit.module.ui.Console p_Console)
    {
        Console = p_Console;
    }
    
    private Command CurrentCommand = null;
    private com.salhack.summit.module.ui.Console Console;
    ...
    public void sendChatMessage(String msg)
    {
        try
        {
            if (CurrentCommand != null) CurrentCommand.processCommand(msg, msg.split(" "));
        }
        catch (Exception e)
        {
