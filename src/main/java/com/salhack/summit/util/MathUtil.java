...
public final class MathUtil
{
    ...
    public static Vec3d interpolateVec3dPos(final Vec3d pos, float renderPartialTicks)
    {
        return new Vec3d(
                calculateDistanceWithPartialTicks(pos.x, pos.x, renderPartialTicks) - mc.getRenderManager().renderPosX,
                calculateDistanceWithPartialTicks(pos.y, pos.y - 0.021, renderPartialTicks) - mc.getRenderManager().renderPosY,
                calculateDistanceWithPartialTicks(pos.z, pos.z, renderPartialTicks) - mc.getRenderManager().renderPosZ);
    }
    ...
    public static double[] directionSpeedNoForward(double speed)
    {
        ...
        float side = 0f;//mc.player.movementInput.moveStrafe;
        float yaw = mc.player.prevRotationYaw
                + (mc.player.rotationYaw - mc.player.prevRotationYaw) * mc.getRenderPartialTicks();
